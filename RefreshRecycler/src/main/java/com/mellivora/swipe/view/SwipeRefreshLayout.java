package com.mellivora.swipe.view;
...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    /**
     * Notify the android.support.design.widget that refresh state has changed. Do not call this when
     * refresh is triggered by a swipe gesture.
     *
     * @param refreshing Whether or not the view should show refresh progress.
     */
    public void pullRefreshing(boolean refreshing, boolean notify) {
    ...
    public void setRefreshResult(boolean result) {
        mCircleView.setImageResource(result ? R.mipmap.gou : R.mipmap.cha);
        if(mCircleView.getDrawable() != null){
            mCircleView.getDrawable().setTint(ContextCompat.getColor(getContext(), R.color.colorAccent));
        }
        handler.postDelayed(resultRunnable, 500);
    }
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        if(overscrollTop == 0) finishSpinner(0);
    }
